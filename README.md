...
```javascript
import gasum from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-gasum@v0.0.7-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-gasum@v0.0.7-deno/mod.js';
```
